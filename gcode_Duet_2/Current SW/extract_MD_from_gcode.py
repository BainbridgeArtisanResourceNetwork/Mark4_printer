...
# If the -md flag was set, prepare for updating the readme.md file in this directory
if update_readme:
	# if the readme file does not exist, create it.
	if not os.path.exists("readme.md"):
		with open("readme.md", 'w') as readme:
			# get the current directory
			my_dir = os.path.split(os.getcwd())[1]
			readme_boilerplate =  "# " + my_dir + " directory\n" +\
...
if parse_all_files:
	...
	for object in os.listdir():
		if os.path.isfile(object):
			...
			if object.split(".")[-1] in ("gcode","G","g","Gcode","GCODE"):
