; Generic macro for loading filament from a directly conencted Mosquito hot end.
...
;Load
M291 P"Insert new Filament into extruder and press OK, cancel to abort the load filament process." R"Load Filamane"  S3  T-1
